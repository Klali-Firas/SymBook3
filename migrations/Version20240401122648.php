 ...
 */
final class Version20240401122648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livres ADD categorie_id INT DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livres DROP categorie_id, CHANGE image image VARCHAR(255) NOT NULL');
    }
}
